        ...
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <div class="media view overlay">
                    <input type="image" class="img-fluid rounded-circle" id="profilePic"
                        src="https://tcas.pondja.com/31959055_1480846662024353_4037302681675497472_n.jpg">
                    <input type="file" id="profileFile" style="display: none">
                    <div class="maskkkkkkk flex-centerrrrrr">
                            ...
                            <div class="card-body">
                                ...
                                <div class="container">
                                    <div class="row text-center">
                                        <div class="col-sm-6 col-12 p-0"><img class="img-thumbnail"
                                                src="images/300X200.gif" alt=""></div>
                                        <div class="col-sm-6 col-12 p-0"><img class="img-thumbnail"
                                                src="images/300X200.gif" alt=""></div>
                                    </div>
                                    <div class="row text-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="row">
                                    <div class="col-9">
                                        <h4><a class="btn btn-success"><span class="oi" data-glyph="eye"></span></a>
                                            รางวัลชนะเลิศการแข่งขันสร้างเว็บเพจ (Web editor) ระดับมัธยมศึกษาตอนปลาย</h4>
                                    </div>
                                    <div class="col-3">
